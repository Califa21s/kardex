class CarnetsReport < Prawn::Document 
  def to_pdf (carnets)
	...
	bounding_box [47.mm, 274.mm], {:width => 85.mm, :height => 25.mm }do
		transparent(1) { stroke_bounds }
		move_down 5.mm
		text " MANUEL DES SPECIFICATIONS DE L\'ORGANISME DE GESTION DU MAINTIEN DE LA NAVIGABILITE", {:align=>:center}
		text "ANNEXES", {:align=>:center, :valign=>:center}
	end
	bounding_box [132.mm, 274.mm], :width => 54.mm, :height => 25.mm do
		data=[["Edition","1"], ["Amendement","0"], ["Date","05/2009"], ["Annexe","6"], ["Page","1"]]
		transparent(1) { stroke_bounds }
	  ...
	  text "ANNEXE 6",{:font_size=>25,:style => :bold,:align=>:center}
	  move_down 12.mm
	  text "RELEVE D'HEURES HEBDOMADAIRE",{:font_size=>16,:style => :bold,:align=>:center}
	  move_down 8.mm
	  font "Helvetica", :size => 12
	  bounding_box [0, cursor], :width => 152.mm, :height => 14.mm do
		transparent(1) { stroke_bounds }
		test="semaine NÂ°"
		cell1=make_cell(test, { :align=>:center,:overflow => :shrink_to_fit, :width => 30.mm,:height => 14.mm,:padding => [0, 0, 0, 0], :borders =>[:right]})
		cell2= make_cell("", { :align=>:center,:overflow => :shrink_to_fit, :width => 30.mm,:height => 14.mm,:padding => [0, 0, 0, 0], :borders =>[:right]})
		cell2_bis= make_cell("", { :align=>:center,:overflow => :shrink_to_fit, :width => 30.mm,:height => 14.mm,:padding => [0, 0, 0, 0], :borders =>[:right]})
		cell3= make_cell("visa Chef Pilote",{ :align=>:center,:overflow => :shrink_to_fit, :width => 30.mm,:height => 14.mm,:padding => [0, 0, 0, 0], :borders =>[:right]})
